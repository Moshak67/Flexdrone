...
export default function EnquiryForm() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('http://localhost:8080/api/v1/enquiry/create', {
                method: 'POST',
                headers: {
                    ...
                    <MDBCard>
                        ...
                        <MDBCardBody>
                            <form onSubmit={handleSubmit}>
                                <div className="row mb-3">
                                    <div className="col">
                                        <MDBInput
                                            ...
                                            name="name"
                                            type="name"
                                            value={user.name ? user.name : enquiry.name}
                                    ...
                                    <div className="col">
                                        <MDBInput
                                            ...
                                            name="email"
                                            type="email"
                                            value={user.email ? user.email : enquiry.email}
                                            onChange={handleInputChange}
                                            required
                                        />
                                    </div>
                                ...
                                {isSubmitted && (
                                    <Alert severity="success" sx={{ mb: 2 }}>Enquiry submitted successfully!</Alert>
                                )}
                            </form>
                        </MDBCardBody>
                    </MDBCard>
